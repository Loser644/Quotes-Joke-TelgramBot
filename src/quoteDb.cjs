const quotes = [
  { name: "Coding Freak", quote: "💪 Strength can be measured by estimation. Not courage." },
  { name: "Coding Freak", quote: "💡 Be strong, but not rude. Be kind, but not weak. Be bold, but don’t bully. Be humble, but not shy. Be proud, but not arrogant." },
  { name: "Coding Freak", quote: "😂 Code is like humor. When you have to explain it, it’s bad." },
